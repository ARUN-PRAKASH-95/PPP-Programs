...
xi = np.array([0,0.774597,-0.774597]) #np.array([0.339981,-0.339981,0.861136,0.861136])                                                   # Gauss points
W_Length   = np.array([0.888889,0.555556,0.555556])  #np.array([0.652145,0.652145,0.347855,0.347855])  
