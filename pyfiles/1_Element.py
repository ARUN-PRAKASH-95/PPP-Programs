...
N_Der_epsilon = np.array([-1/2,1/2])
J_Length   = N_Der_epsilon@X_coor                               #Jacobian for the length of the beam
...
print(Elemental_stiffness_matrix[15,20])
